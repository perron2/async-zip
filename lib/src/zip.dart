...
final zipEntryOpenByIndex =
    zipLib.lookupFunction<ZipEntryOpenByIndexNative, ZipEntryOpenByIndex>('zip_entry_openbyindex');
...
final zipEntryNoAllocRead =
    zipLib.lookupFunction<ZipEntryNoAllocReadNative, ZipEntryNoAllocRead>('zip_entry_noallocread');
